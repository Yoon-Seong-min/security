    ...
    <div className="space-y-8 max-w-2xl">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-blue-900/10 border border-blue-500/20 rounded-xl p-4 text-center">
          ...
          <div className="mt-2 text-cosmos-success">✓ Auto-fetched</div>
        </div>
        <div className="bg-purple-900/10 border border-purple-500/20 rounded-xl p-4 text-center">
          ...
          <div className="mt-2 text-cosmos-dim">Requires passphrase</div>
        </div>
      </div>
      <div className="bg-cosmos-surface border border-cosmos-border rounded-xl p-6 space-y-4">
        ...
        <button onClick={()=>go('indexeddb')} disabled={loading||!passphrase}
          ...
          <div className="text-left"><div className="text-sm font-semibold text-cosmos-accent">Use Local Vault (IndexedDB)</div><div className="text-[10px] text-cosmos-dim">Coordinate map on this device</div></div>
